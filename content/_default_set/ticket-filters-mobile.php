<?php if (!defined('PATH')) { exit; } ?>
            <div class="row mobilefilterarea">
              <div class="col-lg-12">
                <div class="btn-group">
                  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <?php echo ($this->IS_DISPUTED == 'yes' ? $this->TXT[10] : $this->TXT[9]); ?> <span class="caret"></span>
                  </button>
            ...
            <div class="row mobilefilterarea">
              <div class="col-lg-12">
                <div class="btn-group">
                  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <?php echo ($this->IS_DISPUTED == 'yes' ? $this->TXT[11] : $this->TXT[10]); ?> <span class="caret"></span>
                  </button>
                  <ul class="dropdown-menu">
            ...
            <div class="row mobilefilterarea">
              <div class="col-lg-12">
                <div class="btn-group">
                  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <?php echo ($this->IS_DISPUTED=='yes' ? $this->TXT[12] : $this->TXT[11]); ?> <span class="caret"></span>
                  </button>
                  <ul class="dropdown-menu">
