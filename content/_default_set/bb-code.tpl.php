...
<div class="bbButtons">
  ...
  <div class="mobilebreakpoint">
    ...
    <button class="btn btn-success btn-sm" type="button" onclick="window.open('<?php echo $this->SETTINGS->scriptpath; ?>/?bbcode=show','_blank')"><i class="fa fa-question fa-fw"></i></button>
  </div>
</div>