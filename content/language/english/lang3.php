...
$msg_assign2 = '<span class="highlight"><b>{count}</b></span> ticket(s) waiting to be assigned to support staff. Use checkboxes to assign users. Note that further notifications are only sent to assigned users, so if you are the administrator and want to receive ticket reply notifications, you should always add yourself to the assigned list.';
$msg_assign3 = 'Assign To';
$msg_assign4 = '{count} Ticket(s) Assigned';
$msg_assign5 = 'If assigning tickets, send email notification to assigned support team staff? (Will not be sent to person logged in)';
$msg_assign6 = 'Assign';
