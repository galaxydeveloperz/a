...
class mswLic {
  ...
  private $cronFiles = array('email-digest.php', 'db-backup.php', 'close-tickets.php');
  ...
  public function mswEventHandler($code, $domain = '', $key = '', $s = '', $exp = 0) {
    ...
    switch ($code) {
      ...
      case '3':
        ...
        break;
      case '4':
        $e = 'This beta version expired on ' . date('j/M/Y', $exp) . '. All beta versions are valid for 1 month only.<br><br>If you are an active beta tester, please contact us for a new licence file.<br><span style="font-weight:normal"><a href="https://www.maianscriptworld.co.uk/contact">https://www.maianscriptworld.co.uk/contact</a></span><br><br>Remember that beta versions should NOT be used in a production environment.';
        break;
      case '5':
  ...
  public function mswSysCheck() {
    $err = array();
    $cnt = 0;
    if (defined('MSW_PHP_MIN_VER') && phpVersion() < MSW_PHP_MIN_VER) {
