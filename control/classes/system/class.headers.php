...
class htmlHeaders {
  ...
  public static function err403($admin = false, $text = '') {
    ...
    if ($admin) {
      ...
      echo (file_exists(PATH . 'templates/system/headers/403.php') ? str_replace($f, $r, mswTmp(PATH . 'templates/system/headers/403.php')) : '403: Forbidden');
    } else {
  ...
  public static function err404($admin = false, $text = '') {
    ...
    if ($admin) {
      ...
      echo (file_exists(PATH . 'templates/system/headers/404.php') ? str_replace($f, $r, mswTmp(PATH . 'templates/system/headers/404.php')) : '404: Page Not Found');
    } else {
      if (!class_exists('Savant3')) {
        include(PATH . 'control/lib/Savant3.php');
      }
