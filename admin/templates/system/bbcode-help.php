  ...
  <div class="container margin-top-container-nonefixed">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body text_height_25">
        ...
        <div>
		     <b>[dailymotion]</b><?php echo $msg_bbcode30; ?><b>[/dailymotion]</b> = <?php echo $msg_bbcode29; ?>
		    </div>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body text_height_25">
        ...
        <div>
          ...
          <div class="alert alert-info margin_top_10">
            <ul style="list-style-type:upper-alpha"><li><?php echo $msg_bbcode22; ?> 1</li><li><?php echo $msg_bbcode22; ?> 2</li><li><?php echo $msg_bbcode22; ?> 3</li></ul>
          </div>
        </div>
