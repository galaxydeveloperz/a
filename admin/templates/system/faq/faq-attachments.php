...
if (isset($_GET['edit'])) {
  ...
  $EDIT         = mswSQL_table('faqattach','id',$_GET['edit']);
  mswVLQY($EDIT);
  if ($EDIT->path == '') {
    $showAttachUploader = 'no';
  }
}
define('JS_LOADER', 'faq-attachments.php');
?>
  <div class="container margin-top-container min-height-container push" id="mscontainer">
    ...
    <ol class="breadcrumb">
      ...
      <?php
      if (in_array('attachman', $userAccess) || USER_ADMINISTRATOR == 'yes') {
      ?>
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin_top_10">
        <div class="panel panel-default">
            ...
            <div class="tab-content">
              ...
              <div<?php echo (isset($EDIT->id) ? ' class="tab-pane fade"' : ' class="tab-pane active in"'); ?> id="one">
                ...
                <div id="dropzone" class="dropzone">
                  <div class="droparea">
                    <?php echo str_replace('{max}', mswFSC($MSUPL->getMaxSize()), $msadminlang3_1uploads[7]); ?>
                  </div>
                </div>
              ...
              <div<?php echo (isset($EDIT->id) ? ' class="tab-pane active in"' : ' class="tab-pane fade"'); ?> id="two">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="name" value="<?php echo (isset($EDIT->name) ? mswSH($EDIT->name) : ''); ?>">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="remote" value="<?php echo (isset($EDIT->remote) ? mswSH($EDIT->remote) : ''); ?>">
                </div>
                <?php
                }
                ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="size" value="<?php echo (isset($EDIT->size) ? mswSH($EDIT->size) : ''); ?>">
                </div>

                <div class="form-group">
                  <label><?php echo $msadminlang3_1faq[18]; ?></label>
                  <input type="text" class="form-control" name="mimeType" value="<?php echo (isset($EDIT->mimeType) ? mswSH($EDIT->mimeType) : ''); ?>">
                </div>
          ...
          <div class="panel-footer">
            ...
            <button class="btn btn-primary" type="submit" id="upbutton"><i class="fa fa-check fa-fw"></i> <span class="hidden-xs hidden-sm"><?php echo (isset($EDIT->id) ? $msg_attachments12 : $msg_attachments2); ?></span></button>
            ...
            if (in_array('attachman', $userAccess)  || USER_ADMINISTRATOR == 'yes') {
            ?>
            <button class="btn btn-link" type="button" onclick="mswWindowLoc('index.php?p=attachman')"><i class="fa fa-times fa-fw"></i> <span class="hidden-xs hidden-sm"><?php echo $msg_levels11; ?></span></button>
            <?php
            }
            ?>
          </div>
