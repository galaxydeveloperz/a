...
if (isset($_GET['edit'])) {
  ...
  $EDIT          = mswSQL_table('portal','id',$_GET['edit']);
  mswVLQY($EDIT);
}
?>
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin_top_10">
        <div class="panel panel-default">
            ...
            <div class="tab-content">
              <div class="tab-pane active in" id="one">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group input-group">
                    <span class="input-group-addon"><a href="#" onclick="mswPassGenerator('labelPass','userPass');return false" title="<?php echo mswSH($msg_accounts20); ?>"><i class="fa fa-refresh fa-fw"></i></a></span>
              ...
              <div class="tab-pane fade" id="two">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="5" cols="40" name="reason"><?php echo (isset($EDIT->reason) ? mswSH($EDIT->reason) : ''); ?></textarea>
                </div>
              ...
              <div class="tab-pane fade" id="three">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="ip" tabindex="<?php echo (++$tabIndex); ?>" value="<?php echo (isset($EDIT->ip) ? mswSH($EDIT->ip) : ''); ?>">
                </div>
              ...
              <div class="tab-pane fade" id="four">
                 ...
                 <div class="form-group">
                   <textarea class="form-control" rows="5" cols="40" name="notes"><?php echo (isset($EDIT->notes) ? mswSH($EDIT->notes) : ''); ?></textarea>
                 </div>
              ...
              <div class="tab-pane fade" id="five">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group input-group">
                    <span class="input-group-addon"><a href="#" onclick="mswSearchAccounts('dest_email','<?php echo $EDIT->id; ?>');return false" title="<?php echo mswSH($msg_add6); ?>"><i class="fa fa-search fa-fw"></i> </a></span>
          ...
          <div class="panel-footer">
           ...
           <input type="hidden" name="old_pass" value="<?php echo mswSH($EDIT->userPass); ?>">
           <input type="hidden" name="old_email" value="<?php echo mswSH($EDIT->email); ?>">
           <?php
           }
           ?>
