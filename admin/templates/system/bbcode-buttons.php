...
<div class="bbButtons">
  ...
  <div class="mobilebreakpoint">
   ...
   <button class="btn btn-info btn-sm" type="button" onclick="mswBBTags('vimeo','<?php echo $box; ?>')"><i class="fa fa-vimeo fa-fw"></i></button>
   <button class="btn btn-info btn-sm" type="button" onclick="mswBBTags('dailymotion','<?php echo $box; ?>')"><i class="fa fa-play fa-fw"></i></button>
