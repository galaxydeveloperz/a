...
?>
  <div class="container margin-top-container min-height-container push" id="mscontainer">
    ...
    <ol class="breadcrumb">
      ...
      if (isset($_GET['keys'])) {
      ?>
      <li><a href="?p=close"><?php echo $msg_adheader6; ?></a></li>
      <li class="active"><?php echo $mspubliclang3_7[7]; ?> (<?php echo mswNFM($sqlQryRows); ?>)</li>
      <?php
      } else {
      ?>
      <li class="active"><a href="?p=close"><?php echo $msg_adheader6; ?></a> (<?php echo mswNFM($sqlQryRows); ?>)</li>
      <?php
      }
      ?>
    </ol>
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin_top_10">
        <div class="panel panel-default">
          ...
          <div class="panel-footer">
           ...
           <button onclick="mswButtonOp('tickopen');return false;" class="btn btn-success" disabled="disabled" type="button" id="delButton2"><i class="fa fa-unlock fa-fw" title="<?php echo mswSH($msg_open38); ?>"></i> <span class="hidden-xs hidden-sm"><?php echo $msg_open38; ?></span> <span id="mswCVal2">(0)</span></button>
	        </div>
	        <?php
	        }
          ?>
