...
$q = mswSQL_query("SELECT SQL_CALC_FOUND_ROWS *,
     ...
     WHERE `ticketStatus` IN('close','closed')
     AND `isDisputed`      = 'yes'
...
?>
  <div class="container margin-top-container min-height-container push" id="mscontainer">
    ...
    <ol class="breadcrumb">
      ...
      if (isset($_GET['keys'])) {
      ?>
      <li><a href="?p=cdisputes"><?php echo $msg_adheader29; ?></a></li>
      <li class="active"><?php echo $mspubliclang3_7[7]; ?> (<?php echo mswNFM($sqlQryRows); ?>)</li>
      <?php
      } else {
      ?>
      <li class="active"><a href="?p=cdisputes"><?php echo $msg_adheader29; ?></a> (<?php echo mswNFM($sqlQryRows); ?>)</li>
      <?php
      }
      ?>
    </ol>
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin_top_10">
        <div class="panel panel-default">
          ...
          <div class="panel-footer">
            ...
            if (USER_DEL_PRIV == 'yes') {
            ?>
            <button onclick="mswButtonOp('tickdel');return false;" class="btn btn-danger button_margin_right20" disabled="disabled" type="button" id="delButton"><i class="fa fa-trash fa-fw" title="<?php echo mswSH($msg_open23); ?>"></i> <span class="hidden-xs hidden-sm"><?php echo $msg_open23; ?></span> <span id="mswCVal">(0)</span></button>
            <?php
            }
            ?>
            <button class="btn btn-primary button_margin_right20" onclick="mswProcess('tickexp')" type="button" id="delButton3" disabled="disabled"><i class="fa fa-save fa-fw"></i> <span class="hidden-xs hidden-sm"><?php echo $msg_search25; ?></span> <span id="mswCVal3">(0)</span></button>
            <button onclick="mswButtonOp('tickopen');return false;" class="btn btn-success" disabled="disabled" type="button" id="delButton2"><i class="fa fa-unlock fa-fw" title="<?php echo mswSH($msg_open40); ?>"></i> <span class="hidden-xs hidden-sm"><?php echo $msg_open40; ?></span> <span id="mswCVal2">(0)</span></button>
          </div>
	        <?php
	        }
          ?>
